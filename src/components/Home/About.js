  ...
  return (
    <div className="px-5 my-10 mx-3 md:mx-0 bg-gray-100  dark:bg-transparent dark:text-gray-50 py-5 rounded-md">
      ...
      <div className="text-justify md:text-left mb-5 text-base md:text-lg">
        {Data.about.intro}{" "}
        <span className="text-emerald-500 px-2 mx-1 font-bold hover:bg-emerald-500 hover:text-black">
        ...
        <div className="p-4 rounded-md dark:bg-black bg-white dark:shadow-none shadow-sm border-l-4 border-emerald-500">
          ...
          <div className="flex gap-x-2 items-center my-3">
            <a
              ...
              rel="noreferrer"
            >
              <SiUpwork className="h-6 w-6 text-white dark:text-gray-900 dark:bg-emerald-500 bg-black px-1 rounded-sm" />
            </a>
            <a
              ...
              rel="noreferrer"
            >
              <FaGithubSquare className="h-7 w-7 dark:text-emerald-500 text-black " />
            </a>
            <a
              ...
              rel="noreferrer"
            >
              <FaLinkedin className="h-7 w-7 dark:text-emerald-500 text-black " />
            </a>
            <a
              ...
              rel="noreferrer"
            >
              <FaTwitterSquare className="h-7 w-7 dark:text-emerald-500 text-black" />
            </a>
          </div>
        </div>
        <div className="p-4 rounded-md dark:bg-black bg-white dark:shadow-none shadow-sm border-l-4 border-emerald-500">
